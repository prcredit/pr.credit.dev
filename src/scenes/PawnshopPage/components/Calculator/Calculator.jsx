    ...
    return (<>
      <section id="calculator" className="section section-calc">
        <div className="container">
          <h3 className="title calculator__title">
            Калькулятор
          </h3>
          ...
          <div className="content">
                ...
                <form className="calculator_form ajax_form" method="post">
                  ...
                  <div className="range_block sum_block bx">
                    <div className="inp_bx fx w">
                      ...
                      <div className="inp_block">
                        ...
                        <input id="price" type="number" step="100" name="value[10]" min="500" max="50000"/>
                  ...
                  <div className="rb_block payment_type_block bx fx sb">
                    ...
                    <div className="radio_block fx">
                      ...
                      <input className="payment_type" id="payment_type_1" type="radio" name="value[12]" data-val="1" checked/>
                      <label htmlFor="payment_type_1">Тільки відсоток</label>
                      <input className="payment_type" id="payment_type_2" type="radio" name="value[12]" value="Рівномірними частинами" data-val="2"/>
                  ...
                  <div className="rb_block car_block bx fx sb">
                    ...
                    <div className="radio_block fx">
                      ...
                      <input className="car" id="car_1" type="radio" name="value[13]" value="На стоянці" data-val="1" checked/>
                      <label htmlFor="car_1">На стоянці</label>
                      <input className="car" id="car_2" type="radio" name="value[13]" value="У користуванні Клієнта" data-val="2"/>
                  ...
                  <div className="result_block fx sb">
                    ...
                    <div className="result">
                      ...
                      <p className="result_uah"><span className="val">4250</span><span className="currency">грн</span></p>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div className="info">
              <h2 className="calc__title">Ставка за перший місяць — 1%</h2>
              <ul className='calc__list'>
                <li>Отримайте гроші протягом години</li>
                <li>Кредит без підтвердження доходів</li>
                <li>Продовжуйте користуватися вашим авто</li>
                <li>Без витрат КАСКО</li>
              </ul>
            </div>
          </div>
        </div>
