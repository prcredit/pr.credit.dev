              ...
              <form className="calculator_form ajax_form" method="post">
                ...
                <div className="rb_block payment_type_block bx fx sb">
                  ...
                  <div className="radio_block fx">
                    ...
                    <input className="payment_type" id="payment_type_1" type="radio" name="value[12]" data-val="1"
                           defaultChecked={true}/>
                ...
                <div className="rb_block car_block bx fx sb">
                  ...
                  <div className="radio_block fx">
                    ...
                    <input className="car" id="car_1" type="radio" name="value[13]" value="На стоянці" data-val="1"
                           defaultChecked={true}/>
                    <label htmlFor="car_1">На стоянці</label>
                    <input className="car" id="car_2" type="radio" name="value[13]" value="У користуванні Клієнта"
                           data-val="2"
                           />
