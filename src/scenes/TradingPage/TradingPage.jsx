      ...
      <section className="section section-info">
        <div className="container">
          ...
          <p className="subtitle">
            Вам терміново потрібна готівка, але немає часу продавати машину самостійно? Викупимо Ваше авто дорого! Продай авто за 15 хвилин та отримай до 80% вартості автомобіля. Також ти можеш придбати круте авто прямо у нас.
          </p>
        </div>
      </section>
